...
- Strong and stable profitability: R$2.17B in revenue, R$685M in profit and a 31.5% margin, with relatively stable monthly revenue throughout 2025. The drop in revenue in BRL between September and November (-6.6%) was mainly due to the appreciation of the Brazilian real. In USD, sales remained stable (-0.9%), and the slight contraction in real terms was concentrated in Fashion within the South region.
